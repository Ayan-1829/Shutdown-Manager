...
class topWindow:
    ...
    def __init__(self):
        ...
        self.button2 = tkinter.Button(master=self.pu, text='save', bg='#12ffdd', font=button_font, cursor='hand2',
                                      border=5, width=6)
...
def shutdown():
    ...
    obj.button3 = tkinter.Button(master=obj.pu, text='save', bg='#12ffdd', font=('Times', 12, 'bold'), border=5, width=6,cursor='hand2')
...
def info():
    pp = tkinter.Toplevel(st);
    pp.title("System Information")
    pp.geometry("400x400")
    pp.config(bg='#abefef')
    # st.config(bg='#012345')
    # pp.iconbitmap(r'icon/shutdown.ico')
...
system_button = tkinter.Button(    master=st,
                                   text="System Info",
                                   border=5,
                                   bg='#12ffdd',
                                   font=button_font,
...
system_button.place(x=x_coordinate, y=y_coordinate, width=button_width, height=button_hight)
system_button.bind("<Enter>", lambda x: on_enter(system_button))
system_button.bind("<Leave>", lambda x: on_leave(system_button))
y_coordinate += button_distance
